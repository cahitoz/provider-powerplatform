...
PROJECT_NAME ?= provider-powerplatform
PROJECT_REPO ?= github.com/cahitoz/$(PROJECT_NAME)
...
export TERRAFORM_PROVIDER_SOURCE ?= microsoft/power-platform
export TERRAFORM_PROVIDER_REPO ?= https://github.com/microsoft/terraform-provider-power-platform
export TERRAFORM_PROVIDER_VERSION ?= 3.3.0
export TERRAFORM_PROVIDER_DOWNLOAD_NAME ?= terraform-provider-power-platform
export TERRAFORM_PROVIDER_DOWNLOAD_URL_PREFIX ?= https://releases.hashicorp.com/$(TERRAFORM_PROVIDER_DOWNLOAD_NAME)/$(TERRAFORM_PROVIDER_VERSION)
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-power-platform_v3.3.0
...
xpkg.build.provider-powerplatform: do.build.images
